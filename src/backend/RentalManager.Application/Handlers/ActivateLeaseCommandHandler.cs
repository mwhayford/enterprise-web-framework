...
public class ActivateLeaseCommandHandler : IRequestHandler<ActivateLeaseCommand, LeaseDto>
{
    private readonly IApplicationDbContext _context;

    public ActivateLeaseCommandHandler(IApplicationDbContext context)
    {
        _context = context;
    }

    public async Task<LeaseDto> Handle(ActivateLeaseCommand request, CancellationToken cancellationToken)
    {
