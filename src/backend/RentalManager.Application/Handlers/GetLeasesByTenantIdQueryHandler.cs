...
public class GetLeasesByTenantIdQueryHandler : IRequestHandler<GetLeasesByTenantIdQuery, List<LeaseDto>>
{
    private readonly IApplicationDbContext _context;

    public GetLeasesByTenantIdQueryHandler(IApplicationDbContext context)
    {
        _context = context;
    }

    public async Task<List<LeaseDto>> Handle(GetLeasesByTenantIdQuery request, CancellationToken cancellationToken)
    {
