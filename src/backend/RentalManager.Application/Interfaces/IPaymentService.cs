...
public interface IPaymentService
{
    ...
    Task<RentalManager.Domain.Entities.Subscription?> GetSubscriptionAsync(Guid subscriptionId);

    Task<IEnumerable<RentalManager.Domain.Entities.Subscription>> GetUserSubscriptionsAsync(Guid userId, int page = 1, int pageSize = 20);
