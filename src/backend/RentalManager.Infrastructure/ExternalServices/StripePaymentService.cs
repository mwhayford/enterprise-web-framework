...
namespace RentalManager.Infrastructure.ExternalServices;
...
public class StripePaymentService : IPaymentService
{
    ...
    public async Task<Payment> ProcessSubscriptionPaymentAsync(
        ...
        string? paymentMethodId = null)
    {
        var subscription = new RentalManager.Domain.Entities.Subscription(userId, planId, amount);
    ...
    public async Task<RentalManager.Domain.Entities.Subscription?> GetSubscriptionAsync(Guid subscriptionId)
    {
        return await _context.Subscriptions.FindAsync(subscriptionId);
    }

    public async Task<IEnumerable<RentalManager.Domain.Entities.Subscription>> GetUserSubscriptionsAsync(Guid userId, int page = 1, int pageSize = 20)
    {
