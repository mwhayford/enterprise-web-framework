...
export const applicationService = {
  async submitApplication(data: SubmitApplicationDto): Promise<PropertyApplicationDto> {
  ...
  async approveApplication(id: string, decisionNotes?: string): Promise<PropertyApplicationDto> {
  ...
  async rejectApplication(id: string, decisionNotes?: string): Promise<PropertyApplicationDto> {
    const response = await axios.post(
