...
import { applicationService, type ApplicationDataDto, type PreviousAddressDto, type ReferenceDto } from '../services/applicationService';
...
export const ApplicationFormPage = () => {
  ...
  const handleInputChange = (field: keyof ApplicationDataDto, value: string | number | boolean) => {
  ...
  const addPreviousAddress = () => {
    setFormData({
      ...
      previousAddresses: [
        ...
        { address: '', moveInDate: '', moveOutDate: '', landlordName: '', landlordPhone: '', monthlyRent: 0, reasonForLeaving: '' },
      ],
    });
  };

  const updatePreviousAddress = (index: number, field: keyof PreviousAddressDto, value: string | number) => {
  ...
  const removePreviousAddress = (index: number) => {
    setFormData({
      ...formData,
      previousAddresses: formData.previousAddresses.filter((_, i) => i !== index),
    });
  };
  ...
  const updateReference = (index: number, field: keyof ReferenceDto, value: string) => {
  ...
  const handleSubmit = async () => {
    ...
    try {
      ...
      navigate('/applications/my', { state: { message: 'Application submitted successfully!' } });
    } catch (err) {
    ...
    <div className="min-h-screen bg-gray-50">
      ...
      <div className="bg-white border-b border-gray-200">
        <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 py-4">
          ...
          <p className="text-gray-600 mt-1">{property.street}, {property.city}</p>
        </div>
      </div>
      ...
      <div className="bg-white border-b border-gray-200">
        <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 py-4">
          <div className="flex items-center justify-between">
            {['Personal Info', 'Employment', 'Rental History', 'Review'].map((step, index) => (
              <div key={step} className="flex items-center">
                ...
                <span className={`ml-2 text-sm ${index + 1 <= currentStep ? 'text-gray-900' : 'text-gray-500'}`}>
                  {step}
                </span>
                {index < 3 && <ChevronRight className="w-5 h-5 text-gray-400 mx-4" />}
              </div>
            ))}
          </div>
        </div>
        ...
        <div className="bg-white rounded-lg shadow-md p-6">
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                ...
                <div>
                  ...
                  <input
                    ...
                    onChange={(e) => handleInputChange('yearsEmployed', Number(e.target.value))}
                    className="w-full px-3 py-2 border border-gray-300 rounded-md focus:ring-blue-500 focus:border-blue-500"
          ...
          {currentStep === 3 && (
            <div className="space-y-6">
              <div className="flex items-center justify-between">
                <h2 className="text-xl font-bold">Rental History & References</h2>
              </div>
                    ...
                    <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                      ...
                      <div>
                        ...
                        <input
                          ...
                          onChange={(e) => updatePreviousAddress(index, 'moveInDate', e.target.value)}
                          className="w-full px-3 py-2 border border-gray-300 rounded-md focus:ring-blue-500 focus:border-blue-500"
                      ...
                      <div>
                        ...
                        <input
                          ...
                          onChange={(e) => updatePreviousAddress(index, 'moveOutDate', e.target.value)}
                          className="w-full px-3 py-2 border border-gray-300 rounded-md focus:ring-blue-500 focus:border-blue-500"
                      ...
                      <div>
                        ...
                        <input
                          ...
                          onChange={(e) => updatePreviousAddress(index, 'landlordName', e.target.value)}
                          className="w-full px-3 py-2 border border-gray-300 rounded-md focus:ring-blue-500 focus:border-blue-500"
                      ...
                      <div>
                        ...
                        <input
                          ...
                          onChange={(e) => updatePreviousAddress(index, 'landlordPhone', e.target.value)}
                          className="w-full px-3 py-2 border border-gray-300 rounded-md focus:ring-blue-500 focus:border-blue-500"
                      ...
                      <div>
                        ...
                        <input
                          ...
                          onChange={(e) => updatePreviousAddress(index, 'monthlyRent', Number(e.target.value))}
                          className="w-full px-3 py-2 border border-gray-300 rounded-md focus:ring-blue-500 focus:border-blue-500"
                      ...
                      <div className="md:col-span-2">
                        ...
                        <input
                          ...
                          onChange={(e) => updatePreviousAddress(index, 'reasonForLeaving', e.target.value)}
                          className="w-full px-3 py-2 border border-gray-300 rounded-md focus:ring-blue-500 focus:border-blue-500"
            ...
            <div className="space-y-6">
              ...
              <div className="bg-gray-50 rounded-lg p-4 space-y-3">
                ...
                <div>
                  ...
                  <p className="text-sm text-gray-700">
                    ...
                    Annual Income: ${formData.annualIncome.toLocaleString()}<br />
              ...
              <div className="flex items-start gap-2">
                ...
                <label htmlFor="terms" className="text-sm text-gray-700">
                  I certify that all information provided in this application is true and complete. I authorize the landlord
                  to verify this information and conduct background checks as necessary.
                </label>
              </div>
            </div>
          )}
