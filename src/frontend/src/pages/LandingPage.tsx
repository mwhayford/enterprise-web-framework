            ...
            <div className="mt-16 grid grid-cols-1 gap-8 sm:grid-cols-2 lg:grid-cols-3">
              ...
              >
                ...
                <div className="relative bg-white p-8 rounded-xl shadow-sm hover:shadow-lg transition-shadow">
                  ...
                  <p className="text-gray-600">
                    Give tenants access to pay rent, submit maintenance
              ...
              >
                ...
                <div className="relative bg-white p-8 rounded-xl shadow-sm hover:shadow-lg transition-shadow">
                  ...
                  <p className="text-gray-600">
                    Track maintenance requests, assign tasks, and keep a
                    complete history of all repairs and updates.
                  </p>
                </div>
              </motion.div>
          ...
          <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            <div className="text-center">
              ...
              <p className="mt-6 text-xl text-blue-100 max-w-2xl mx-auto">
                Join thousands of property managers who trust RentalManager to
                run their business.
              </p>
              <div className="mt-10">
                <Button
