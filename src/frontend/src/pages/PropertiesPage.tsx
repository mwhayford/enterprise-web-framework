...
import { propertyService, type PropertyFilters as PropertyFiltersType } from '../services/propertyService';
import type { PropertyListDto, PagedResult } from '../services/propertyService';

export const PropertiesPage = () => {
  const [properties, setProperties] = useState<PagedResult<PropertyListDto> | null>(null);
  const [loading, setLoading] = useState(true);
  const [error, setError] = useState<string | null>(null);
  const [filters, setFilters] = useState<PropertyFiltersType>({ pageNumber: 1, pageSize: 12 });
      ...
      <div className="bg-white border-b border-gray-200">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-6">
          ...
          <p className="mt-2 text-gray-600">
            {properties ? `${properties.totalCount} properties available` : 'Loading...'}
          </p>
        </div>
      </div>
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
        <div className="flex gap-6">
          ...
          <div className="flex-1">
            ...
            {!loading && !error && properties && properties.items.length === 0 && (
              ...
              <>
                ...
                {properties.totalPages > 1 && (
                  <div className="mt-8 flex items-center justify-center gap-2">
                    <button
                      onClick={() => handlePageChange(properties.pageNumber - 1)}
                    ...
                    <div className="flex items-center gap-2">
                      ...
                      {properties.totalPages > 5 && (
                        <>
                          ...
                          <button
                            onClick={() => handlePageChange(properties.totalPages)}
                            className={`px-4 py-2 rounded-md ${
