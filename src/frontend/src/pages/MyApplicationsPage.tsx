    ...
    <div className="min-h-screen bg-gray-50">
      ...
      <div className="bg-white border-b border-gray-200">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-6">
          ...
          <p className="mt-2 text-gray-600">Track the status of your rental applications</p>
        </div>
      </div>
        ...
        {!loading && !error && applications.length > 0 && (
          <div className="space-y-4">
            {applications.map((application) => {
              const applicationData = application.applicationData ? JSON.parse(application.applicationData) : null;
                ...
                <div key={application.id} className="bg-white rounded-lg shadow-md overflow-hidden">
                  <div className="p-6">
                      ...
                      <div className="flex-1">
                        <div className="flex items-center gap-3 mb-2">
                          <h3 className="text-lg font-semibold text-gray-900">
                            Property ID: {application.propertyId.substring(0, 8)}...
                          </h3>
                          <div className={`flex items-center gap-2 px-3 py-1 rounded-full text-sm font-semibold ${statusColors[application.status]}`}>
                        ...
                        <div className="grid grid-cols-1 md:grid-cols-3 gap-4 text-sm">
                          <div>
                            ...
                            <span className="ml-2 font-medium">{formatDate(application.submittedAt)}</span>
                          </div>
                          <div>
                        ...
                        {application.decisionNotes && (
                          <div className="mt-4 p-3 bg-gray-50 rounded-md">
                            ...
                            <p className="text-sm text-gray-600">{application.decisionNotes}</p>
                          </div>
                        )}
                      </div>
                    </div>
                    ...
                    <div className="mt-4 pt-4 border-t border-gray-200 flex items-center justify-between">
                      ...
                      {application.status === 0 && !application.applicationFeePaymentId && (
