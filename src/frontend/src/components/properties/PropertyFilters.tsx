...
export const PropertyFilters = ({ onFilterChange, onClose, isMobile = false }: PropertyFiltersProps) => {
  ...
  const handleInputChange = (field: keyof PropertyFiltersType, value: string) => {
    const numValue = value === '' ? undefined : Number(value);
    const newFilters = { ...filters, [field]: field === 'city' || field === 'state' || field === 'searchTerm' ? value || undefined : numValue };
